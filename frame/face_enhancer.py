...
from swapper.face_analyser import get_many_faces
...
def get_device() -> str:
    if 'CUDAExecutionProvider' in swapper.globals.execution_providers:
        return 'cuda'
    if 'CoreMLExecutionProvider' in swapper.globals.execution_providers:
        return 'mps'
    return 'cpu'
...
def process_video(source_path: str, temp_frame_paths: List[str]) -> None:
    swapper.processors.frame.core.process_video(None, temp_frame_paths, process_frames)
